                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="confirm('Are you sure, you want to delete this slide ?') || event.stopImediatePropagation()" wire:click.prevent="deleteSlide({{$slide->id}})" style="margin-left:10px"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
