        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                    ...
                    <img src="{{ asset('images/slider/service_1') }}/{{$slide->image}}" alt="{{$slide->title}}" data-bgposition="center center"
    ...
    <section class="content-central">
        ...
        <div>
            ...
            <div id="boxes-carousel">
                ...
                <div>
                    <a class="g-list" href="{{route('home.service_details',['service_slug'=>$sservice->slug])}}">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails') }}/{{$sservice->thumbnail}}" alt="{{$sservice->name}}" class="img-responsive">
                        </div>

                        <div class="info-gallery">
                            <h3>{{$sservice->name}}</h3>
                            <hr class="separator">
                            <p>{{$sservice->tagline}}</p>
                            <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$sservice->slug])}}"
                                    class="btn btn-primary">Book Now</a></div>
                            <div class="price"><span>&#36;</span><b>From</b>${{$sservice->price}}</div>
                        </div>
                    </a>
                </div>
                @endforeach
